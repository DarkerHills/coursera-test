...
export function EmailCapture() {
  ...
  return (
    <form
      ...
      className="flex w-full items-center justify-between overflow-hidden rounded-sm border border-black/15 bg-white pl-3 shadow-sm transition-shadow duration-300 focus-within:shadow-[0_0_0_3px_rgba(31,61,58,0.15)]"
    ...
    >
      ...
      <input
        ...
        className="w-full bg-transparent py-2 font-mhmw-body text-[15px] font-semibold text-mhmw-text-black capitalize outline-none placeholder:text-mhmw-text-black/45"
      />
      <button
        type="submit"
